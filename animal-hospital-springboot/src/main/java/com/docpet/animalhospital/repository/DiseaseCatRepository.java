...
@Repository
public interface DiseaseCatRepository extends JpaRepository<DiseaseCat, Long> {

    @Query("SELECT d FROM DiseaseCat d WHERE " +
    ...
    List<DiseaseCat> searchByKeyword(@Param("keyword") String keyword, Pageable pageable);
}
