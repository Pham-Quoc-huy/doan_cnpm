...
@Repository
public interface DiseaseDogRepository extends JpaRepository<DiseaseDog, Long> {

    @Query("SELECT d FROM DiseaseDog d WHERE " +
    ...
    List<DiseaseDog> searchByKeyword(@Param("keyword") String keyword, Pageable pageable);
}
